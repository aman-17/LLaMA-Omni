...
class Omni2Speech2SConfig(Olmo2Config):
    model_type = "omni2_speech2s_olmo2"


class Omni2Speech2SOlmo2ForCausalLM(Omni2SpeechOlmo2ForCausalLM, GenerationWithTTS):
    ...
    def forward(
        ...
        lm_output = super(Omni2SpeechOlmo2ForCausalLM, self).forward(
            input_ids=input_ids,
...
AutoConfig.register("omni2_speech2s_olmo2", Omni2Speech2SConfig)
AutoModelForCausalLM.register(Omni2Speech2SConfig, Omni2Speech2SOlmo2ForCausalLM)
